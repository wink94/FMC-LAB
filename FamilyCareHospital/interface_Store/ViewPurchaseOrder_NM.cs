...
{
    public partial class ViewPurchaseOrder_NM : Form
    {
        public ViewPurchaseOrder_NM()
        {
            InitializeComponent();
            tableLoad();
        }
        ...
        {
            MySqlCommand mcmd = new MySqlCommand("select * from itp.store_order_nm where Current_Status = 'pending'", mc);
        ...
        private void btn_ro_Click(object sender, EventArgs e)
        {
            MySqlCommand mcmd = new MySqlCommand("select * from itp.store_order_nm where Return_status = 'return'", mc);
        ...
        private void btn_pns_Click(object sender, EventArgs e)
        {
            MySqlCommand mcmd = new MySqlCommand("select * from itp.store_order_nm where Payment_Status = 'not settle'", mc);
