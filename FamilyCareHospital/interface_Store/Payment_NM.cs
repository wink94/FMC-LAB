...
{
    public partial class Payment_NM : Form
    {
        public Payment_NM()
        {
            InitializeComponent();
        ...
        public void autoGenerateID()
        {
            String McID = "NMSP";
            mc.Open();
            MySqlCommand cmd = new MySqlCommand("select COUNT(Payment_ID) from itp.store_payment_nm", mc);
        ...
        public void tableLoad()
        {
            ...
            MySqlCommand mcmd = new MySqlCommand("select * from itp.store_payment_nm", mc);
        ...
        private void btn_add_Click(object sender, EventArgs e)
        {
            if (comboBox1.Text != "" && comboBox1.Text != "select" && txt_sid.Text != "" && txt_oid.Text != "")
            {
                ...
                String query = "insert into itp.store_payment_nm (Payment_ID,Order_ID,Supplier_ID,Entry_Date,Payment_Amount,Payment_Type) values('" + txt_pid.Text + "','" + txt_oid.Text + "','" + txt_sid.Text + "','" + dateTimePicker1.Text + "','" + txt_pa.Text + "','" + comboBox1.Text + "');";
        ...
        private void btn_edit_Click(object sender, EventArgs e)
        {
            ...
            if (dialog == DialogResult.Yes)
            {
                ...
                if (comboBox1.Text != "" && comboBox1.Text != "select" && txt_sid.Text != "" && txt_oid.Text != "")
                {
                    ...
                    String query = "update itp.store_payment_nm set Order_ID= '" + txt_oid.Text + "', Supplier_ID = '" + txt_sid.Text + "', Entry_Date = '" + dateTimePicker1.Text + "', Payment_Amount =  '" + txt_pa.Text + "',Payment_Type = '" + comboBox1.Text + "'  where Payment_ID = '" + txt_pid.Text + "';";
                    MySqlCommand cmd = new MySqlCommand(query, mc);
                    MySqlDataReader mr;
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            ...
            if (dialog == DialogResult.Yes)
            {
                if (txt_pid.Text != "")
                {
                    ...
                    String query = "delete from itp.store_payment_nm  where Payment_ID = '" + txt_pid.Text + "';";
                    MySqlCommand cmd = new MySqlCommand(query, mc);
                    MySqlDataReader mr;
            ...
            if (searchType != "select" && searchType != "")
            {
                ...
                if (searchKey != "")
                {
                    ...
                    if (searchType == "Payment ID")
                    {
                        ...
                        MySqlCommand mcmd = new MySqlCommand("select * from itp.store_payment_nm where Payment_ID = '" + searchKey + "'", mc);
                    ...
                    else if (searchType == "Order ID")
                    {
                        ...
                        MySqlCommand mcmd = new MySqlCommand("select * from itp.store_payment_nm where Order_ID = '" + searchKey + "'", mc);
        ...
        private void txt_search_MouseClick(object sender, MouseEventArgs e)
        {
            if (comboBox2.Text == "Payment ID")
            {
                ...
                String query = "select * from itp.store_payment_nm ;";
                MySqlCommand cmd = new MySqlCommand(query, mc);
                MySqlDataReader mr;
