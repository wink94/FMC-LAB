...
{
    public partial class IssueOrder_NM : Form
    {
        public IssueOrder_NM()
        {
            InitializeComponent();
            tableload();
            autocomplete();
        ...
        public void autoGenerateID()
        {
            String MOID = "NMIO";
            mc.Open();
            MySqlCommand cmd = new MySqlCommand("select COUNT(distinct Issue_Order_ID) from itp.store_issueorder_nm", mc);
            int i = Convert.ToInt32(cmd.ExecuteScalar());
            i++;
            mc.Close();

            txt_iorderid.Text = MOID + i.ToString();
        }
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            if (txt_search.Text != "")
            {
                MySqlCommand mcmd = new MySqlCommand("select ItemID,Name,Batch_Number,Expier_Date,Quantity,Unit_Price from itp.store_item_nm where Name = '" + txt_search.Text + "'", mc);
        ...
        private void btn_add_Click(object sender, EventArgs e)
        {
            if (comboBox1.Text != "select" && comboBox1.Text != "")
            {
                ...
                if (txt_iID.Text != "" && txt_bn.Text != "" && txt_qn.Text != "" && txt_qn.Text != "" && txt_name.Text != "")
                {

                    mc.Open();
                    MySqlCommand cmd = new MySqlCommand("select Quantity from itp.store_item_nm where ItemID = '" + txt_iID.Text + "' and Batch_Number = '" + txt_bn.Text + "' and Expier_Date = '" + dateTimePicker1.Text + "'  ", mc);
                    ...
                    if (answer >= 0)
                    {
                        ...
                        String query = "update itp.store_item_nm set Quantity = '" + qn + "' where ItemID = '" + txt_iID.Text + "' and Batch_Number = '" + txt_bn.Text + "' and Expier_Date = '" + dateTimePicker1.Text + "' ;";
                        ...
                        MySqlCommand mcmd = new MySqlCommand("select ItemID,Name,Batch_Number,Expier_Date,Quantity,Unit_Price from itp.store_item_nm where ItemID = '" + txt_iID.Text + "' and Batch_Number = '" + txt_bn.Text + "' and Expier_Date = '" + dateTimePicker1.Text + "'", mc);
        ...
        private void btn_remove_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView2.SelectedRows.Count > 0)
            {
                ...
                if (iID != "" && bn != "" && qnt != "")
                {
                    ...
                    mc.Open();
                    MySqlCommand cmd = new MySqlCommand("select Quantity from itp.store_item_nm where ItemID = '" + iID + "' and Batch_Number = '" + bn + "' and Expier_Date = '" + exdate + "'  ", mc);
                    int q = Convert.ToInt32(cmd.ExecuteScalar());
                    mc.Close();
                    ...
                    String query = "update itp.store_item_nm set Quantity = '" + qn + "' where ItemID = '" + iID + "' and Batch_Number = '" + bn + "' and Expier_Date = '" + exdate + "' ;";
                    MySqlCommand cmd2 = new MySqlCommand(query, mc);
                    MySqlDataReader mr;
                    ...
                    MySqlCommand mcmd = new MySqlCommand("select ItemID,Name,Batch_Number,Expier_Date,Quantity,Unit_Price from itp.store_item_nm where ItemID = '" + iID + "' and Batch_Number = '" + bn + "' and Expier_Date = '" + exdate + "'", mc);
        ...
        private void btn_issue_Click(object sender, EventArgs e)
        {
            ...
            if (dialog == DialogResult.Yes)
            {
                ...
                {
                    mc.Open();
                    MySqlCommand cmd = new MySqlCommand("insert into itp.store_issueorder_nm (Issue_Order_ID,Department,Entry_Date,ItemID,Name,Batch_Number,Expier_Date,Quantity,Unit_price) values(@Issue_Order_ID,@Department,@Entry_Date,@ItemID,@Name,@Batch_Number,@Expier_Date,@Quantity,@Unit_price)", mc);
            ...
            if (dialog == DialogResult.Yes)
            {
                try
                {
                    ...
                    for (int i = 0; i < dataGridView2.Rows.Count; i++)
                    {
                        ...
                        MySqlCommand cmd = new MySqlCommand("select Quantity from itp.store_item_nm where ItemID = @ItemID and Batch_Number = @Batch_Number and Expier_Date = @Expier_Date ", mc);
                        ...
                        MySqlCommand cmd1 = new MySqlCommand("update itp.store_item_nm set Quantity ='" + qn + "' where ItemID = @ItemID and Batch_Number = @Batch_Number and Expier_Date = @Expier_Date ", mc);
        ...
        public void cancle()
        {
            try
            {
                ...
                for (int i = 0; i < dataGridView2.Rows.Count; i++)
                {
                    ...
                    MySqlCommand cmd2 = new MySqlCommand("delete from itp.store_issueorder_nm where issue_order_id = @issue_order_id and ItemID = @ItemID and Batch_Number = @Batch_Number and Expier_Date = @Expier_Date", mc);
