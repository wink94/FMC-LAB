...
namespace FamilyCareHospital
{
    public partial class ViewStock : Form
    {
        ...
        private void btn_expI_Click(object sender, EventArgs e)
        {
            MySqlCommand mcmd = new MySqlCommand("select * from itp.store_item where Expier_Date between '" +dateTimePicker1.Text+ "' and '"+dateTimePicker2.Text+"'", mc);
        ...
        {
            MySqlCommand mcmd = new MySqlCommand("select * from itp.store_item where Quantity < 10", mc);
        ...
        {
            MySqlCommand mcmd = new MySqlCommand("select * from itp.store_item where Quantity = 0", mc);
