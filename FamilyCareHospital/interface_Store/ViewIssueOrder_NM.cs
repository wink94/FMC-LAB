...
{
    public partial class ViewIssueOrder_NM : Form
    {
        public ViewIssueOrder_NM()
        {
            InitializeComponent();
            tableLoad();
        }
        ...
        public void tableLoad()
        {
            ...
            MySqlCommand mcmd = new MySqlCommand("select * from itp.store_issueorder_nm", mc);
        ...
        private void txt_search_MouseClick(object sender, MouseEventArgs e)
        {
            if (comboBox1.Text == "Issue Order ID")
            {
                ...
                String query = "select * from itp.store_issueorder_nm;";
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            if (comboBox1.Text == "Issue Order ID")
            {
                ...
                MySqlCommand mcmd = new MySqlCommand("select * from itp.store_issueorder_nm where Issue_Order_ID = '" + txt_search.Text + "' ", mc);
            ...
            {
                MySqlCommand mcmd = new MySqlCommand("select * from itp.store_issueorder_nm where Department = '" + txt_search.Text + "' ", mc);
        ...
        {
            MySqlCommand mcmd = new MySqlCommand("select * from itp.store_issueorder_nm where Entry_Date = '" + dateTimePicker1.Text + "' ", mc);
        ...
        private void btn_removeall_Click(object sender, EventArgs e)
        {
            if (txt_id.Text != "")
            {
                ...
                if (dialog == DialogResult.Yes)
                {
                    ...
                    String query = "delete from itp.store_issueorder_nm where Issue_Order_ID = '" + txt_id.Text + "'   ;";
                    MySqlCommand cmd = new MySqlCommand(query, mc);
                    MySqlDataReader mr;
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dialog == DialogResult.Yes)
            {
                ...
                if (e.ColumnIndex == 0)
                {
                    ...
                    String query = "delete from itp.store_issueorder_nm where Issue_Order_ID = '" + issue_o_id + "' and Department = '" + dept + "' and ItemID = '" + item_id + "' and Batch_Number = '" + bn + "'  ;";
                    MySqlCommand cmd = new MySqlCommand(query, mc);
                    MySqlDataReader mr;
