...
namespace FamilyCareHospital
{
    public partial class PurchaseOrder : Form
    {
        ...
        public void autoGenerateID()
        {
            String poID = "MPO";
            mc.Open();
            MySqlCommand cmd = new MySqlCommand("select COUNT( distinct OrderID ) from itp.store_order_m", mc);
        ...
        {
            if (txt_Qn.Text != "" && txt_name.Text != "" && txt_order.Text != "" && txt_supplier.Text != "")
            {
                String query = "insert into itp.store_order_m (OrderID,Name,Category,Quantity,SupplierID,Entry_Date) values('" + txt_order.Text + "','" + txt_name.Text + "','" + comboBox1.Text + "','" + txt_Qn.Text + "','" + txt_supplier.Text + "','" + dateTimePicker1.Text + "');";
                MySqlCommand cmd = new MySqlCommand(query, mc);
                MySqlDataReader mr;
        ...
        private void btn_edit_Click(object sender, EventArgs e)
        {
            ...
            if (dialog == DialogResult.Yes)
            {
                ...
                if (txt_Qn.Text != "" && txt_order.Text != "" && txt_supplier.Text != "" && txt_name.Text != "")
                {
                    String query = "update itp.store_order_m set  Category = '" + comboBox1.Text + "', Quantity ='" + txt_Qn.Text + "', SupplierID ='" + txt_supplier.Text + "', Entry_Date = '" + dateTimePicker1.Text + "' where OrderID='" + txt_order.Text + "' and Name='" + txt_name.Text + "';";
                    MySqlCommand cmd = new MySqlCommand(query, mc);
                    MySqlDataReader mr;
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            ...
            if (dialog == DialogResult.Yes)
            {
                ...
                {
                    String query = "delete from itp.store_order_m where OrderID = '" + txt_order.Text + "' and Name = '" + txt_name.Text + "';";
                    MySqlCommand cmd = new MySqlCommand(query, mc);
                    MySqlDataReader mr;
        ...
        private void btn_editStatus_Click(object sender, EventArgs e)
        {
            if (txt_order.Text != "" && txt_name.Text != "")
            {
                ...
                String query = "update itp.store_order_m set Current_Status = '" + comboBox3.Text + "', Receive_Date = '" + dateTimePicker2.Text + "', Payment_Status ='" + comboBox4.Text + "', Return_status ='" + comboBox5.Text + "', Entry_Date = '" + dateTimePicker1.Text + "' where OrderID='" + txt_order.Text + "' and Name='" + txt_name.Text + "' ;";
                MySqlCommand cmd = new MySqlCommand(query, mc);
                MySqlDataReader mr;
