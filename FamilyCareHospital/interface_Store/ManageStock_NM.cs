...
{
    public partial class ManageStock_NM : Form
    {
        public ManageStock_NM()
        {
            InitializeComponent();
            tableLoad();
            autoGenerateID();
        ...
        public void autoGenerateID()
        {
            String McID = "NMSI";
            mc.Open();
            MySqlCommand cmd = new MySqlCommand("select COUNT(distinct ItemID) from itp.store_item_nm", mc);
        ...
        private void btn_add_Click(object sender, EventArgs e)
        {
            ...
            {
                String query = "insert into itp.store_item_nm (ItemID,Name,Category,Batch_Number,Manufactuer,Entry_Date,Production_Date,Expier_Date,Quantity,Unit_Price)  values('" + txt_itemID.Text + "','" + txt_name.Text + "','" + comboBox1.Text + "','" + txt_BN.Text + "','" + txt_M.Text + "','" + dtp_Entry.Text + "','" + dtp_Pro.Text + "','" + dtp_expier.Text + "','" + txt_Qn.Text + "','" + txt_UP.Text + "');";
                MySqlCommand cmd = new MySqlCommand(query, mc);
                MySqlDataReader mr;
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            ...
            if (dialog == DialogResult.Yes)
            {
                ...
                {
                    String query = "delete from itp.store_item_nm  where ItemID = '" + txt_itemID.Text + "' and Expier_Date = '" + dtp_expier.Text + "' and Batch_Number ='"+txt_BN.Text+"';";
                    MySqlCommand cmd = new MySqlCommand(query, mc);
                    MySqlDataReader mr;
