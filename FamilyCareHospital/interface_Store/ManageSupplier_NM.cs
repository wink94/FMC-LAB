...
{
    public partial class ManageSupplier_NM : Form
    {
        public ManageSupplier_NM()
        {
            InitializeComponent();
            autoGenerateID();
            tableLoad();
        ...
        public void autoGenerateID()
        {
            String McID = "NMSUP";
            mc.Open();
            MySqlCommand cmd = new MySqlCommand("select COUNT(SupplierID) from itp.store_suplier_nm", mc);
        ...
        public void tableLoad()
        {
            ...
            MySqlCommand mcmd = new MySqlCommand("select * from itp.store_suplier_nm", mc);
        ...
        private void btn_add_Click(object sender, EventArgs e)
        {
            ...
            {
                String query = "insert into itp.store_suplier_nm (SupplierID,Name,Category,Address,Contact_Number,Agent_Name,Agent_Contactnumber) values('" + txt_supID.Text + "','" + txt_name.Text + "','" + comboBox3.Text + "','" + txt_address.Text + "','" + txt_contactnum.Text + "','" + txt_aname.Text + "','" + txt_acn.Text + "');";
                MySqlCommand cmd = new MySqlCommand(query, mc);
                MySqlDataReader mr;
        ...
        private void btn_edit_Click(object sender, EventArgs e)
        {
            ...
            if (dialog == DialogResult.Yes)
            {
                if (txt_supID.Text != "" && txt_name.Text != "")
                {
                    ...
                    String query = "update itp.store_suplier_nm set Name = '" + txt_name.Text + "',Category = '" + comboBox3.Text + "', Address = '" + txt_address.Text + "',Contact_Number ='" + txt_contactnum.Text + "',Agent_Name ='" + txt_aname.Text + "',Agent_Contactnumber ='" + txt_acn.Text + "' where SupplierID = '" + txt_supID.Text + "';";
                    MySqlCommand cmd = new MySqlCommand(query, mc);
                    MySqlDataReader mr;
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            ...
            if (dialog == DialogResult.Yes)
            {
                if (txt_supID.Text != "" && txt_name.Text != "")
                {
                    ...
                    String query = "delete from itp.store_suplier_nm  where SupplierID = '" + txt_supID.Text + "';";
                    MySqlCommand cmd = new MySqlCommand(query, mc);
                    MySqlDataReader mr;
            ...
            if (searchType != "select" && searchType != "")
            {
                ...
                if (searchKey != "")
                {
                    ...
                    if (searchType == "Name")
                    {
                        ...
                        MySqlCommand mcmd = new MySqlCommand("select * from itp.store_suplier_nm where Name = '" + searchKey + "'", mc);
                    ...
                    else if (searchType == "Supplier ID")
                    {
                        ...
                        MySqlCommand mcmd = new MySqlCommand("select * from itp.store_suplier_nm where SupplierID = '" + searchKey + "'", mc);
        ...
        private void btn_view_Click(object sender, EventArgs e)
        {
            ...
            {
                MySqlCommand mcmd = new MySqlCommand("select * from itp.store_suplier_nm where Category = '" + comboBox2.Text + "'", mc);
